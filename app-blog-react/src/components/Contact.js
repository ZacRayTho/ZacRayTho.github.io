          ...
          <div className="row">
            <div className="col-6 d-flex justify-content-center ">
              <a
                ...
                target="_blank"
              >
                <img src="../img/contactStuff/email.svg" />
              </a>
            </div>
            <div className="col-6 d-flex justify-content-center ">
              <a href="https://github.com/ZacRayTho" target="_blank">
                <img src="../img/contactStuff/github.svg" />
              </a>
            </div>
            <div className="col-6 d-flex justify-content-center ">
              <a href="tel:8593190903">
                <img src="../img/contactStuff/phone.svg" />
              </a>
            </div>
            <div className="col-6 d-flex justify-content-center ">
              <a
                ...
                target="_blank"
              >
                <img src="../img/contactStuff/linkedin.svg" />
              </a>
            </div>
          </div>
        </div>
